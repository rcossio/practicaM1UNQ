...
\begin{enumerate}
	...
	\begin{enumerate} [label=(\alph*)]
		...
		\item ~\\ [-12pt] \includegraphics[width=55mm]{func4.png} \vfill
	\end{enumerate}
	\end{multicols}
...
\end{enumerate}\exercise---\exercise---\exercise---\exercise---\exercise---\exercise---\exercise---\exercise---\exercise---\exercise---\exercise---\end{enumerate}\end{document}