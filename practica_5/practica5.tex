...
\begin{enumerate}
	...
	\begin{enumcols}[3]
		...
		\item $\tan(2x)-1$
		\answer Considerando $f(x)=\tan(x)$, la función es $g(x)=f(2x)-1$. $D_g=\R\setminus\{x\in\R ~|~ x=\f{k\pi}{2} con k\in\Z\}$. $I_g=\R$. $P=\f{\pi}{2}$. \\ \img{7cm}{img/tan1.png}

	\end{enumcols}
	
	\exercise Redefinir las funciones trigonométricas indicadas para que sean biyectivas, obtener su inversa. Obtener el dominio e imagen de la función inversa y graficarla.
	\begin{enumcols}[3]
		\item $\sin^{-1}(x)=\arcsin(x)$. Al redefinir el dominio de $\sin(x)$ priorizar los números cercanos a cero.
		\item $\cos^{-1}(x)=\arccos(x)$. Al redefinir el dominio de $\cos(x)$ priorizar los números positivos.
		\item $\tan^{-1}(x)=\arctan(x)$. Al redefinir el dominio de $\tan(x)$ priorizar los números cercanos a cero.
	\end{enumcols}
