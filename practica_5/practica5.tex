...
\begin{enumerate}
	...
	% Aca pondría una función que tome palabras y devuelva la longitud de la palabra. Como para que no sean sólo funciones reales.
	% O tambien una función que concatene palabras f(x)=x+'mesa' f(sobre)=sobremesa.
	% O una función que reemplaze vocales por otras.
	% O una función que tome pares ordenados y devuelva numeros f(x,y)=x+y
	% O una función clasificadora (partida)
