...
\begin{enumerate}
	...
	\begin{enumcols}[3]
		...
		\answer $D_f=\R$. $I_f=\R$. \\ \img{6cm}{img/piece1.png}
		\item $f(x)=\SEL{-x & si ~~x\leq 0\\ x  & si ~0<x\leq 3 \\ -x & si ~x>3}$
		\answer $D_f=\R$. $I_f=(-\infty,3)\union [0,+\infty)$. \\ \img{6cm}{img/piece2.png}
		\item $f(x)=\SEL{3x-2 & si ~~x\leq 2 \\ x^2 & si ~~2<x\leq 3 \\ \f{x+6}{9} & si ~x>3}$
		\answer $D_f=\R$. $I_f=\R$. \\ \img{6cm}{img/piece3.png}
		\item $f(x)=\SEL{x^2+7 & si ~~x\leq 2\\ x+4 & si ~~x>2}$
		\answer $D_f=\R$. $I_f=(6,+\infty)$. \\ \img{6cm}{img/piece4.png}
		\item $f(x)=|x|$
		\answer $D_f=\R$. $I_f=[0,+\infty)$. \\ \img{6cm}{img/piece5.png}
	\end{enumcols}
