...
\practiceheader{Práctica 6: Técnicas de conteo y número combinatorio}{Comisión: Rodrigo Cossio-Pérez y Leonardo Lattenero}
...
\begin{enumerate}
	...
	\begin{enumcols}
		...
		\item En una fiesta se encuentran 10 hombres y 8 mujeres. ¿De cuantas formas pueden integrarse en parejas (no ordenadas) de distinto género para bailar una pieza?
		\answer $1814400$. Primero se toman 8 hombres de los 10, es decir, $\binom{10}{8}=45$ opciones. Luego se asignan los hombres en 8 posiciones definidas por las mujeres, es decir, $P(8,8)=8!=40320$ alternativas. Por lo que las alternativas totales son $45.40320=1814400$. Para verlo de otra forma podemos armar 8 parejas. Para armar la primera pareja se elije un hombre y una mujer: $10.8$ alternativas. Para formar la segunda quedan sólo 9 hombres y 7 mujeres, asi que $9.7$ alternativas. Así sucesivamente hasta formar las 8 parejas ordenadas, es decir, $(10.8).(9.7).(8.6).(7.5).(6.4).(5.3).(4.2).(3.1)=(10.8).(9.7).(8.6).(7.5)(6.4).(5.3).(4.2).(3.1)$. Luego eliminamos el orden artificial de las parejas dividiendo por $P(8,8)=8!$, que queda $1814400$.  

		\item En una fiesta se encuentran 18 personas. ¿De cuantas formas pueden integrarse en parejas numeradas para bailar una pieza? Si las parejas no tuvieran un órden, ¿de cuántas formas sería?
		\answer 12504636144000 si son parejas ordenadas o 34459425 si son desordenadas. Se conformarán 9 parejas. Para la primera se eligen 2 personas de 18, es decir $\binom{18}{2}$ opciones. Para la segunda 2 de las 16 restantes, es decir $\binom{16}{2}$. Y así sucesívamente. Por lo tanto el número total de opciones es $\binom{18}{2}\binom{16}{2}\binom{14}{2} \cdots \binom{4}{2}\binom{2}{2}=\frac{18!}{(2!)^9}=12504636144000$. Si las parejas son desordenadas ese número se divide por $P(9,9)=9!$, es decir, $34459425$.
		...
		\answer $715$. Se seleccionan 4 personas de las 13, es decir, $\binom{13}{4}=715$ opciones. Otra forma es considerar las distintas cantidades de mujeres por comisión, que varía entre $0$ y $5$, dando lugar a: $\binom{8}{4}\binom{5}{0}+\binom{8}{3}\binom{5}{1}+\binom{8}{2}\binom{5}{2}+\binom{8}{1}\binom{5}{3}+\binom{8}{0}\binom{5}{4}= 70.1 + 56.5 + 28.10+ 8.10+ 1.5=715$
